...
import com.a51tgt.t4m.lib.camera.CameraManager;
import com.a51tgt.t4m.lib.decode.CaptureActivityHandler;
import com.a51tgt.t4m.lib.decode.InactivityTimer;
 ...
 * 二维码扫描
 */
public class Capture2Activity extends Activity implements Callback {
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new CaptureActivityHandler(Capture2Activity.this);
		}
	}

package com.a51tgt.t4m.net;

/**
 * Created by liu_w on 2017/9/11.
 */
...
//        boolean b = mWifiManager.enableNetwork(wcgID, true);
    ...
    public void addNetwork(ScanResult scanResult, String passwd, int type) {
        ...
        addNetwork(createWifiInfo(scanResult, passwd));
    }
